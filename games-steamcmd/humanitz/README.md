...
in your source panel too, so a later export retains this URL. Existing server
files are unchanged until you apply the updated egg and reinstall as described above.
